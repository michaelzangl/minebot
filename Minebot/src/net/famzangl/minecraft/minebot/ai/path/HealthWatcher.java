...
public class HealthWatcher {
	...
	private MinebotSettings settings = new MinebotSettings();
	...
	public AITask getOverrideTask(float health) {
		health -= EPSILON;
		int commandTh = settings.getInt("on_damage_command_level", -1);
		...
		int logoutTh = settings.getInt("on_damage_logout_level", -1);
