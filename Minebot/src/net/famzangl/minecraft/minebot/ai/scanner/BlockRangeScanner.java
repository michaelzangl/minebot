...
public class BlockRangeScanner {
	...
	public static class ChestData {
		private final class SameItemFilter implements ItemFilter {
			private final ItemStack displayed;

			private SameItemFilter(ItemStack displayed) {
	...
	private void addReachable(Pos allowed, ChestData c) {
		...
		if (list == null) {
			list = new ArrayList<BlockRangeScanner.ChestData>();
			reachable.put(allowed, list);
		}
		list.add(c);
	}

	private void scanBlock(AIHelper helper, int x, int y, int z) {
